...
- Use one app toolbar sidebar toggle with a stable fixed-width sidebar. Avoid native overlay/sidebar behavior that can clip sidebar contents or cover the PDF page.
