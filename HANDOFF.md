...
- `Sources/FileViewer/AIAssistant.swift`: messages, scopes, sessions, provider protocol, LM Studio adapter, streaming orchestration, prompt construction, document extraction, chunking, keyword retrieval, and the 60,000-character cap.
...
- no conversation persistence, export, Copy/Retry buttons, or clickable citations yet.
